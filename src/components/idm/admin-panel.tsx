...
export function AdminPanel() {
  ...
  const { data: players } = useQuery({
    ...
    queryFn: async () => { try { const res = await fetch(`/api/players?division=${storeDivision}`, { credentials: 'include' }); if (!res.ok) return []; return res.json(); } catch { return []; } },
