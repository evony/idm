...
const DEFAULT_SKINS = [
  ...
  },
  {
    ...
    description: 'Skin juara 1 tournament — Royal Gold, satu kesatuan dengan juara lainnya',
    icon: '👑',
  ...
  },
  {
    type: 'champion_2',
    displayName: 'Royal Gold Crown',
    description: 'Skin juara 2 tournament — Royal Gold, satu kesatuan dengan juara lainnya',
    icon: '👑',
  ...
  },
  {
    type: 'champion_3',
    displayName: 'Royal Gold Crown',
    description: 'Skin juara 3 tournament — Royal Gold, satu kesatuan dengan juara lainnya',
    icon: '👑',
