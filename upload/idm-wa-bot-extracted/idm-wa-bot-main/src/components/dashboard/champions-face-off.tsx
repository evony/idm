    ...
    >
      ...
      <div className="relative h-20 overflow-hidden">
        <div
          ...
          style={{ backgroundImage: "url('/images/champions-podium.png')" }}
        />
      ...
      >
        {maleChamp && (
          <ChampionTeamCard
            champ={maleChamp}
            divisionImage="/images/male-division.png"
        ...
        {femaleChamp && (
          <ChampionTeamCard
            champ={femaleChamp}
            divisionImage="/images/female-division.png"
  ...
  const teamMembers = [
    {
      ...
      isLeader: true,
      avatar: `/images/avatar-${isMale ? 'male' : 'female'}-${champ.player.tier.toLowerCase()}.png`,
    },
    {
      name: champ.player.clubName ? `${champ.player.clubName} Dancer` : 'Dancer 2',
      tier: champ.player.tier === 'S' ? 'A' : 'B',
      isLeader: false,
      avatar: `/images/avatar-${isMale ? 'male' : 'female'}-${champ.player.tier === 'S' ? 'a' : 'b'}.png`,
    },
    {
