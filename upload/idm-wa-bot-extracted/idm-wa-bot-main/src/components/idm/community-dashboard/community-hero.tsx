...
import { getOptimizedCloudinaryUrl, parseWitaDate, formatCurrencyShort } from '@/lib/utils';
...
/* ═══════════════════════════════════════════════════════
   Date/Time Helpers — Indonesian locale formatting
   ═══════════════════════════════════════════════════════ */
...
function formatHari(date: Date): string {
...
/** Parse scheduledAt as WITA time — uses shared parseWitaDate utility */
const parseSchedule = parseWitaDate;
          ...
          {schedule && (
            <>
              <DetailItem
                icon={Calendar}
                label="Tanggal"
                value={formatTanggal(schedule)}
                iconColor={textAccent}
              />
              <DetailItem
                icon={Clock}
                label="Waktu"
                value={formatWaktu(schedule)}
                iconColor={textAccent}
                mono
              />
              <DetailItem
...
export function CommunityHero({ maleData, femaleData, leagueData, onSawer, onRegister }: CommunityHeroProps) {
