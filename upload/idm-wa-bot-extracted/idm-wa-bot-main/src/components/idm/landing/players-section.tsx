                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    {(showAllMalePlayers ? malePlayers : malePlayers.slice(0, 8)).map((player, idx) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`club-card relative rounded-2xl border text-center transition-all duration-300 overflow-hidden group-hover/player:-translate-y-1 ${
                              skinColors
                                ? ''
                                : isChampion
                          ...
                          >
                            ...
                            <div
                              ...
                              style={skinColors
                                ? { background: `linear-gradient(90deg, transparent 10%, ${skinColors.frame}60 35%, ${skinColors.frame} 50%, ${skinColors.frame}60 65%, transparent 90%)` }
                                : { background: 'linear-gradient(90deg, transparent 10%, rgba(46,159,255,0.5) 35%, rgba(46,159,255,0.8) 50%, rgba(46,159,255,0.5) 65%, transparent 90%)' }
                              }
                            />
                            ...
                            <div className="absolute inset-0 flex items-center justify-center opacity-[0.10] group-hover/player:opacity-[0.13] transition-opacity duration-500 pointer-events-none">
                              <Image src={getAvatarUrl(player.gamertag, 'male', player.avatar)} alt="" width={160} height={160} className="w-[70%] h-auto aspect-square object-cover rounded-full" aria-hidden="true" />
                            </div>
                            ...
                            <div className="relative z-10 flex flex-col items-center px-4 pt-8 pb-5">
                              ...
                              <div className="relative mb-4">
                                ...
                                >
                                  <Image src={getAvatarUrl(player.gamertag, 'male', player.avatar)} alt={player.gamertag} fill sizes="96px" className="object-cover object-top" />
                                </div>
                                {/* Champion badge */}
                                {isChampion && (
                                  <div className="absolute -top-2 -right-2 z-20 min-w-[22px] h-[22px] rounded-full bg-[#d4a853] flex items-center justify-center shadow-lg shadow-[#d4a853]/30 border-2 border-mid">
                                    <span className="text-[8px] font-black text-mid leading-none">#1</span>
                                  </div>
                                )}
                                {/* Top3 badge */}
                                {isTop3 && !isChampion && (
                                  <div className="absolute -top-2 -right-2 z-20 min-w-[22px] h-[22px] rounded-full bg-[#2E9FFF] flex items-center justify-center shadow-lg shadow-[#2E9FFF]/30 border-2 border-mid">
                              ...
                              <p
                                className={`text-sm font-black truncate max-w-full transition-colors duration-200 mt-1 flex items-center justify-center gap-1 ${
                                  skinColors
                                    ? ''
                                    : isChampion
                                      ? 'text-[#d4a853]'
                                      : isTop3
                                        ? 'text-[#57B5FF]'
                                        : 'text-white group-hover/player:text-[#57B5FF]'
                                }`}
                                style={skinColors ? {
                        ...
                        >
                          ...
                          >
                            ...
                            <div
                              ...
                              style={skinColors
                                ? { background: `linear-gradient(90deg, transparent 10%, ${skinColors.frame}60 35%, ${skinColors.frame} 50%, ${skinColors.frame}60 65%, transparent 90%)` }
                                : { background: 'linear-gradient(90deg, transparent 10%, rgba(255,45,120,0.5) 35%, rgba(255,45,120,0.8) 50%, rgba(255,45,120,0.5) 65%, transparent 90%)' }
                              }
                            />

                            {/* Avatar watermark background */}
                            <div className="absolute inset-0 flex items-center justify-center opacity-[0.10] group-hover/player:opacity-[0.13] transition-opacity duration-500 pointer-events-none">
                              <Image src={getAvatarUrl(player.gamertag, 'female', player.avatar)} alt="" width={160} height={160} className="w-[70%] h-auto aspect-square object-cover rounded-full" aria-hidden="true" />
                            </div>
                            ...
                            <div className="relative z-10 flex flex-col items-center px-4 pt-8 pb-5">
                              ...
                              <div className="relative mb-4">
                                ...
                                >
                                  <Image src={getAvatarUrl(player.gamertag, 'female', player.avatar)} alt={player.gamertag} fill sizes="96px" className="object-cover object-top" />
                                </div>
                                {/* Champion badge */}
                                {isChampion && (
                                  <div className="absolute -top-2 -right-2 z-20 min-w-[22px] h-[22px] rounded-full bg-[#d4a853] flex items-center justify-center shadow-lg shadow-[#d4a853]/30 border-2 border-mid">
                                ...
                                {/* Top3 badge */}
                                {isTop3 && !isChampion && (
                                  <div className="absolute -top-2 -right-2 z-20 min-w-[22px] h-[22px] rounded-full bg-[#FF2D78] flex items-center justify-center shadow-lg shadow-[#FF2D78]/30 border-2 border-mid">
                                    <span className="text-[8px] font-black text-mid leading-none">#{idx + 1}</span>
                                  </div>
                                )}
                                ...
                                className={`text-sm font-black truncate max-w-full transition-colors duration-200 mt-1 flex items-center justify-center gap-1 ${
                                  skinColors
                                    ...
                                    : isChampion
                                      ...
                                      : isTop3
                                        ? 'text-[#FF5C9A]'
                                        : 'text-white group-hover/player:text-[#FF5C9A]'
                                }`}
                                style={skinColors ? {
                                  color: primaryNameColor || skinColors.frame,
                                  textShadow: `0 0 6px ${skinColors.glow}, 0 0 16px ${skinColors.glow}`,
