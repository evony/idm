...
type PlayerModalMode = 'choose' | 'login' | 'register';
        ...
        <div className="p-5 pt-3 relative">
          ...
          {activeView === 'peserta' && !isPlayerLoggedIn && (
            <button
              ...
              className="absolute top-3 left-5 w-8 h-8 rounded-lg bg-muted/40 hover:bg-idm-gold/15 border border-border/30 hover:border-idm-gold/30 flex items-center justify-center transition-all group z-10"
              title="Login Admin"
            >
              <Shield className="w-4 h-4 text-muted-foreground group-hover:text-idm-gold transition-colors" />
            </button>
          )}
          ...
          {activeView === 'admin' && !isAdminLoggedIn && (
            <button
              ...
              className="absolute top-3 left-5 w-8 h-8 rounded-lg bg-muted/40 hover:bg-idm-male/15 border border-border/30 hover:border-idm-male/30 flex items-center justify-center transition-all group z-10"
              title="Kembali ke Login Peserta"
            >
              <Gamepad2 className="w-4 h-4 text-muted-foreground group-hover:text-idm-male transition-colors" />
            </button>
          )}
                  ...
                  <div className="space-y-2.5">
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[10px] text-muted-foreground">Daftar sebagai pemain turnamen</p>
                      </div>
                    </button>
                  </div>
